...
Annotated.register = function (handlers) {
  handlers.contentPackages['acos-annex-html'] = Annotated;
  handlers.contentTypes.annotated.installedContentPackages.push(Annotated);
};

Annotated.namespace = 'acos-annex-html';
Annotated.contentTypeNamespace = 'annotated';
Annotated.packageType = 'content';

Annotated.meta = {
  'name': 'acos-annex-html',
  'shortDescription': 'webex annotated examples for html',
  'description': '',
  'author': 'PAWS Lab',
  'license': 'MIT',
  'version': '0.0.1',
